...
export default function SettingsView() {
  ...
  // Active Settings Tab
  const [settingsTab, setSettingsTab] = useState<'workspaces' | 'appearance' | 'extension' | 'backup'>('workspaces');
    ...
    <Fade in timeout={400}>
      <Box sx={{ pb: 4, maxWidth: 900, mx: 'auto' }}>
        ...
        <Box sx={{ mb: 3, borderBottom: 1, borderColor: 'divider' }}>
          ...
          >
            <Tab icon={<WorkspacesRoundedIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Workspaces" value="workspaces" />
            <Tab icon={<PaletteRoundedIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Appearance" value="appearance" />
            <Tab icon={<ExtensionRoundedIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Companion Extension" value="extension" />
            <Tab icon={<FileDownloadRoundedIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Data & Backup" value="backup" />
          </Tabs>
        </Box>
        ...
        {settingsTab === 'backup' && (
          <Card sx={{ p: 2.5, mb: 2.5 }}>
            ...
            <Alert severity="info" sx={{ mb: 2.5, fontSize: '0.80rem' }}>
